...
Note that this implementation has key differences from the standard OMP implementation, including the imposition of a hard constraint for mass conservation, support for flexible redfield ratios, and support for soft penalties to encode prior knowledge about end-member distributions.
